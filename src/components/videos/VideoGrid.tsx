...
import { fetchVideos } from "@/lib/drive";
      ...
      {!loading && !error && videos.length === 0 && (
        <div className="flex flex-col items-center justify-center py-20 gap-4">
          ...
          <p className="text-gray-600 text-sm max-w-md text-center">
            Upload videos through the Upload Hub and they&apos;ll appear here
            automatically within 30 seconds.
          </p>
          <a
            href="/upload"
            className="btn-val-secondary text-[0.7rem] px-6 py-2 mt-2"
          >
            GO TO UPLOAD HUB
          </a>
        </div>
            ...
            >
              ...
              <div className="bg-dark-card">
                ...
                <div className="p-4 relative">
                  ...
                  <div className="flex items-center gap-2 text-[0.75rem] text-gray-600">
                    {video.createdTime && (
                      <>
  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Info */}
        <div className="p-6 flex items-center justify-between border-t border-glass-border">
          <div>
